...
meeting.assets = [50.0, 10.0, 1.0;   %suma = 55, zostalo = 15
                  20.0, 2.0, 20.0;   %suma = 24, zostalo = 21
                  14.0, 10.0, 90.0;   %suma = 13, zostalo = 52
                  8.0, 2.0, 15.0]    %suma = 11, zostalo = 39
meeting.means = [1, 2, 3]                                              %suma = 103
...
meeting.assets = [14.0, 18.0, 1.0;    %suma = 6, zostalo = 9
                  9.0, 0.0, 19.0;    %suma = 9, zostalo = 12
                  20.0, 10.0, 13.0;  %suma = 30, zostalo = 22
                  25.0, 10.0, 5.0]   %suma = 11, zostalo = 28
...
%meeting.assets = [3.00, 0.0, 3.0;   %suma = 6, zostalo = 3
%                  15.0, 0.0, 5.0;   %suma = 20, zostalo = -6
%                  30.0, 0.0, 1.0;   %suma = 30, zostalo = -9
%                  5.00, 0.0, 30.0]  %suma = 35, zostalo = -7
%meeting.means = [1, 3]                                                %suma = 91
